...
- 画面视觉描述应当尽量具体、真实。`;
    ...
    // ── 9c5. 聊天底层最高级别提示词 (最高人设钢印) ──
    systemPrompt += `\n\n### 🌟 神经链接智能体生存法则 (Highest Directive)
...
5. **线上聊天精炼法则**: 线上聊天时，为了维持真实的聊天节奏，你每轮的输出应当控制在最多 3-5 条短句或短气泡，避免大段长篇大论。
6. **线上线下剧情连贯性**: 当你们处于线上聊天（ChatApp）与线下见面（DateApp）彼此切换时，剧情和记忆必须保持高度的连贯性，自然接续上一次相处的事件细节。`;
